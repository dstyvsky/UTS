...
(function() {
  $(document).on("page:change", function() {
    ...
    $('#warehouse').click(function() {
      $('.service_overview').fadeOut(0);
      return $('#warehouse_container').fadeIn(0);
    });
    $('#transloading').click(function() {
      $('.service_overview').fadeOut(0);
      return $('#transloading_container').fadeIn(0);
    });
    $('#drayage').click(function() {
      $('.service_overview').fadeOut(0);
      return $('#drayage_container').fadeIn(0);
    });
    $('#stripping').click(function() {
      $('.service_overview').fadeOut(0);
      return $('#stripping_container').fadeIn(0);
    });
    $('#packaging').click(function() {
      $('.service_overview').fadeOut(0);
      return $('#packaging_container').fadeIn(0);
    });
    $('#rail_access').click(function() {
      $('.service_overview').fadeOut(0);
      return $('#rail_access_container').fadeIn(0);
    });
    $('#welding').click(function() {
      $('.service_overview').fadeOut(0);
      return $('#welding_container').fadeIn(0);
    });
    return $('#trucking').click(function() {
      $('.service_overview').fadeOut(0);
      return $('#trucking_container').fadeIn(0);
    });
  });
